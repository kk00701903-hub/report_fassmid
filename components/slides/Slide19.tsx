...
const SLIDE_HTML = `<div class="war-room-slide-root" style="overflow: hidden;">
<!-- Title Region -->
...
<span><a href="https://kk00701903-hub.github.io/fass-dailyscrum/#/analytics" target="_blank" rel="noopener noreferrer" style="color:var(--ppt-accent);font-weight:600;">FASS 데일리 스크럼 Analytics</a>으로 일단위 업무·스프린트 진척도를 점검하고 워룸에서 공유</span>
</div>
<div class="war-room-highlight-item">
...
<div class="war-room-dashboard-preview">
<a class="war-room-dashboard-box" href="https://kk00701903-hub.github.io/fass-dailyscrum/#/analytics" target="_blank" rel="noopener noreferrer" style="border-color:var(--ppt-accent);text-decoration:none;cursor:pointer;">
...
<div class="war-room-badge-container">
<div class="war-room-status-badge" style="border-color: var(--ppt-accent-2);color: var(--ppt-accent-2);">핵심 성과 지표(KPI) 연동</div>
<div class="war-room-status-badge" style="border-color: var(--ppt-good);color: var(--ppt-good);">무결점 배포 보장</div>
</div>
</div>
</div>
</div>
...
export default function Slide19() {
  return (
    <SlideCanvas slideId={19} motion="cards" motionTier="medium">
