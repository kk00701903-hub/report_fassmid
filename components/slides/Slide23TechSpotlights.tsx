...
export const SPOTLIGHTS: SpotlightDef[] = [
  {
    ...
    sub: "인프라 · 자동화",
    color: "#ffffff",
    bg: "linear-gradient(145deg, #0078d4 0%, #004578 100%)",
    border: "#004578",
    glow: "rgba(0, 72, 120, 0.45)",
  },
  {
    id: "docker",
    label: "Docker",
    sub: "컨테이너 표준화",
    color: "#ffffff",
    bg: "linear-gradient(145deg, #0091e2 0%, #0a558c 100%)",
    border: "#0a558c",
    glow: "rgba(0, 85, 140, 0.45)",
  },
  {
    id: "gitlab",
    label: "GitLab CI",
    sub: "빌드 · 배포 파이프라인",
    color: "#ffffff",
    bg: "linear-gradient(145deg, #e24329 0%, #8a2400 100%)",
    border: "#8a2400",
    glow: "rgba(138, 36, 0, 0.4)",
  },
  {
    id: "nextjs",
    label: "Next.js",
    sub: "React 19 · SSR",
    color: "#ffffff",
    bg: "linear-gradient(145deg, #484644 0%, #201f1e 100%)",
    border: "#201f1e",
