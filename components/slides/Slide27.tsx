...
const SLIDE_HTML = `<div class="section-slide-root">
  ...
  <div class="section-topics-list">
    ...
    <div class="section-topic-item"><div class="topic-dot"></div><span class="topic-text">비즈니스 혁신6: FinOps·클라우드 비용 최적화</span></div>
    ...
    <div class="section-topic-item"><div class="topic-dot"></div><span class="topic-text">비즈니스 혁신8: 빌더형 인재 육성</span></div>
  </div>
</div>`;
