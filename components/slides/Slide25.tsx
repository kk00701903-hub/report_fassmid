...
const SLIDE_HTML = `<div class="migration-slide-root fluent-slide" style="overflow: hidden;">
<!-- Title Region -->
<div class="title-region-wrapper">
<div class="title-main-header">
<div class="title-accent-bar"></div>
<h1 class="title-text-content">#. 별첨 아키텍처 원칙 2: 무중단 데이터 동기화 <span class="title-text-en">(Zero-downtime migration)</span></h1>
</div>
...
<div class="migration-node-desc migration-node-note">기본 비즈니스 트랜잭션 데이터</div>
</div>
</div>
<!-- Engine -->
...
<div class="migration-engine-caption">
<span>변경 데이터 캡처 및 즉시 파이프라인 송출</span>
</div>
</div>
</div>
<!-- Next-Gen -->
<div class="migration-right-nextgen-column">
<div class="migration-node-box migration-node-box--target">
...
export default function Slide24() {
  return (
    <SlideCanvas slideId={25} motion="architecture" motionTier="medium">
