...
export const SLIDES: Slide[] = [
  ...
  { id: 17, title: "통합 프로토타입을 통한 아키텍쳐 내재화" },
  { id: 18, title: "PART 4 - 혁신 및 검증" },
  { id: 19, title: "AI 기반 스마트 물류 최적화" },
  { id: 20, title: "무결점(Zero-Defect) 코드 품질 통제 체계" },
  { id: 21, title: "FinOps 관점의 철저한 클라우드 예산 절감 훈련" },
  { id: 22, title: "지능형 코드 변환 아키텍처 (RAG)" },
  { id: 23, title: "AI 개발 혁신 — 도구 투자 · 오케스트레이션 · 인재육성" },
  { id: 24, title: "차세대 웹프레임워크 × 빌더형 인재 육성" },
  { id: 25, title: "타사 프로젝트 규모 비교 참고" },
  { id: 26, title: "100억 원의 자산 창출과 ASP 비즈니스 대전환" },
  { id: 27, title: "FaSS 최종 목표: MSA 전환 전략" },
  { id: 28, title: "중장기 아키텍처 원칙 2: Kubernetes (컨테이너 오케스트레이션)" },
