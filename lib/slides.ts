...
export const SLIDES: Slide[] = [
  ...
  { id: 10, title: "최적화 방안 2. 프로젝트 워룸 (War Room) 운영" },
  ...
  { id: 17, title: "중장기 아키텍처 원칙 3: Kubernetes (컨테이너 오케스트레이션)" },
  { id: 18, title: "CI/CD 자동화 아키텍처 - FaSS 플랫폼" },
  { id: 19, title: "무중단 데이터 동기화 - FaSS 플랫폼" },
  { id: 20, title: "PART 4 - 혁신 및 검증" },
  { id: 21, title: "100억 원의 자산 창출과 ASP 비즈니스 대전환" },
  { id: 22, title: "통합 프로토타입 개발 착수 — 주유소(JTGS) 관리 시스템" },
  { id: 23, title: "AI 기반 스마트 물류 최적화" },
  { id: 24, title: "FaSS 차세대 플랫폼 — 대용량 데이터 처리" },
  { id: 25, title: "무결점(Zero-Defect) 코드 품질 통제 체계" },
  { id: 26, title: "FinOps 관점의 철저한 클라우드 예산 절감 훈련" },
  { id: 27, title: "타사 프로젝트 규모 비교 참고" },
  { id: 28, title: "지능형 코드 변환 아키텍처 (RAG)" },
  { id: 29, title: "AI 개발 혁신 — 도구 투자 · 오케스트레이션 · 인재육성" },
  { id: 30, title: "차세대 웹프레임워크 × 빌더형 인재 육성" },
  { id: 31, title: "PART 5 - 로드맵 및 미래 비전" },
  { id: 32, title: "무결점 비즈니스 전환을 위한 단계적 롤아웃 로드맵" },
  { id: 33, title: "(주)제때 차세대 FaSS 플랫폼 구축 6월 중간 보고 - 맺음말" },
];
