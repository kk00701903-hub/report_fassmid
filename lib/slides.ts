...
export const SLIDES: Slide[] = [
  ...
  { id: 6, title: "AI 디지털 워커 (AI Digital Worker)" },
  { id: 7, title: "PART 2 - 프로젝트 진행 경과 및 성과" },
  { id: 8, title: "최정예 TFT 인력 구성 및 애자일 조직 운영" },
  { id: 9, title: "워룸 구축 · FASS 데일리 스크럼" },
  { id: 10, title: "AI 기반 디자이너·외주 개발 인력 대체" },
  { id: 11, title: "최적의 안전성 검증: PoC 타겟 선정 및 완료" },
  { id: 12, title: "PART 3 - 기술 스택 및 아키텍처" },
  { id: 13, title: "FaSS Platform v3.0 — 핵심 기술 스택 총괄" },
