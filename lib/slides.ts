...
export const SLIDES: Slide[] = [
  ...
  { id: 9, title: "타사 프로젝트 비교" },
  { id: 10, title: "AI-Augmented 개발 워크플로우" },
  { id: 11, title: "프로젝트 진행경과 마일스톤" },
  { id: 12, title: "최적화 방안 1. AI 디지털 워커 활용" },
  { id: 13, title: "최적화 방안 2. 애자일 워룸 운영" },
  { id: 14, title: "최적화 방안 3. 사전 POC 운영" },
  { id: 15, title: "PART 3 - 기술 스택 및 아키텍처" },
  { id: 16, title: "핵심 기술 스택" },
  { id: 17, title: "아키텍처 원칙 1: 모듈러 모놀리스 (안정성 극대화)" },
  { id: 18, title: "아키텍처 원칙 2: 무중단 데이터 동기화 (Zero-downtime migration)" },
  { id: 19, title: "아키텍처 원칙 3: CI/CD 자동화 (DevOps · GitOps)" },
  { id: 20, title: "PART 4 - 혁신 및 검증" },
  { id: 21, title: "비즈니스 혁신1: 차세대 영업 핵심 IT 엔진 보유" },
  { id: 22, title: "비즈니스 혁신2: AI 지능형 물류 플랫폼으로의 전환" },
  { id: 23, title: "비즈니스 혁신3: 전략적 수익화 IT 플랫폼 확보" },
  ...
  { id: 27, title: "비즈니스 혁신7: DGX·Claude Code 오케스트레이션 및 프로세스 지침" },
