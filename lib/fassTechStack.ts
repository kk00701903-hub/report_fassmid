...
export const FASS_TECH_LAYERS: TechStackLayer[] = [
  {
    ...
    items: [
      ...
      { name: "RealGrid", detail: "대용량 비즈니스 데이터 처리에 특화된 웹 엔터프라이즈 그리드", sprintId: "S09" },
      { name: "Modal", detail: "화면 이동 없는 팝업형 다이얼로그 UI 제공 컴포넌트", sprintId: "S09" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Spring Batch", detail: "정해진 시간에 대용량 데이터를 안전하게 일괄 처리하는 스케줄링", sprintId: "S10" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "LDAP", detail: "사내 디렉토리 서비스(조직/사용자 정보) 연계 인증", sprintId: "S05" },
      { name: "OIDC", detail: "OAuth 2.0 기반의 안전한 분산 환경 사용자 인증 프로토콜", sprintId: "S05" },
  ...
  },
  {
    ...
    accent: "#22c55e",
    items: [
      { name: "Redis", detail: "인메모리 기반 고속 데이터 캐싱 및 분산 세션 상태 공유", sprintId: "S03" },
      ...
      { name: "Kafka", detail: "캡처된 대규모 데이터 이벤트를 병목 없이 타 시스템으로 분산 전송", sprintId: "S17" },
    ],
  },
  {
    id: "infra",
    ...
    items: [
      ...
      { name: "Docker Compose", detail: "단일 호스트에서 멀티 컨테이너 애플리케이션 환경을 정의하고 로컬 실행 제어", sprintId: "S02" },
      { name: "Kubernetes (K8s)", detail: "컨테이너화된 애플리케이션의 자동 배포, 확장(Scaling) 및 고가용성 운영 관리(오케스트레이션)", sprintId: "S02" },
      { name: "GitLab CI", detail: "소스 코드 버전 관리 및 지속적 통합(CI) 파이프라인 자동화 구축", sprintId: "S02" },
      { name: "Nexus Repository", detail: "사내 표준 라이브러리, 패키지 및 빌드 아티팩트 중앙 저장소 관리", sprintId: "S02" },
      { name: "SonarQube", detail: "소스 코드 품질 정적 분석 및 보안 취약점 사전 탐지", sprintId: "S02" },
      { name: "ArgoCD", detail: "GitOps 기반의 지속적 배포(CD) 자동화 및 인프라 상태 동기화", sprintId: "S02" },
      ...
      { name: "Grafana", detail: "시스템 인프라 및 애플리케이션의 시계열 매트릭(성능/상태) 모니터링 시각화", sprintId: "S22" },
    ],
  },
  {
    id: "ai",
