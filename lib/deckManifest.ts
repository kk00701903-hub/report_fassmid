...
export const DECK_MANIFEST: DeckSlideEntry[] = [
  ...
  { slideId: 19, title: "최적화 방안 1. AI 디지털 워커 활용 (당사 자체개발)", role: "content" },
  ...
  { slideId: 3, title: "핵심 기술 방향성 ① — 3Tier 구조 (Web-WAS-DB)", role: "glossary" },
  { slideId: 4, title: "핵심 기술 방향성 ② — 도커 (Docker) (물류 컨테이너 예시)", role: "glossary" },
  { slideId: 5, title: "핵심 기술 방향성 ③ — MSA 구조 (물류작업 예시)", role: "glossary" },
  { slideId: 6, title: "핵심 기술 방향성 ④ — CDC 방식 (물류 재고조사 예시)", role: "glossary" },
  {
    slideId: 27,
