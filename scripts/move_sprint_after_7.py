"""Move 스프린트 운영현황 (old slide 32) to position 8, right after PART 2 divider."""
...
TEMP = ROOT / "scripts" / "_move_sprint_tmp"

# User asked for page 31; 스프린트 운영현황 is currently slide 32 (31 = 맺음말).
SPRINT_SLIDE = 32
...
def main() -> None:
    ...
    write_slide_parts()
    bump_title_version()
    print("Moved sprint slide to position 8 (after PART 2).")
    for n in range(7, 13):
